...
function EditProductPickType(props) {
  const classes = new useStyles();
  const {
    productPickType,
    setProductPickType,
    editProductTypeDialog,
    setEditProductTypeDialog,
  } = props;
  ...
  useEffect(() => {
    if (editProductTypeDialog) {
      setProductPickTypeCombine(productPickType);
      handleSetProductType1AndType2();
    }
  }, [editProductTypeDialog]);
  ...
  const handleSetProductType1AndType2 = () => {
    let buildType1;
    let buildType2;
    if (
      productPickType?.productTypes &&
      productPickType?.productTypes[0].subType
    ) {
      const productType1 = [];
      const productType2 = [];
      productPickType.productTypes.map((productType) => {
        productType1.push(productType.nameType);
      });
      productPickType.productTypes[0].subType.productSubTypes.map(
        (productSubType) => {
          productType2.push(productSubType.nameType);
        }
      );
      buildType1 = {
        nameType: productPickType.nameType,
        productTypes: productType1,
      };
      buildType2 = {
        nameType: productPickType.productTypes[0].subType.nameSubType,
        productTypes: productType2,
      };
      setProductPickType1(buildType1);
      setProductPickType2(buildType2);
      ...
      const buildProductType = {
        ...
        productTypes: newProductPickType1.productTypes.map(
          (productType, index) => ({
            ...
            picture: {
              src:
                productPickTypeCombine?.productTypes?.[index]?.picture.src ||
                "",
              upload:
            ...
            subType: {
              ...
              productSubTypes: newProductPickType2.productTypes.map(
                (productType2, index2) => ({
                  ...
                  quantity:
                    productPickTypeCombine?.productTypes?.[index]?.subType
                      ?.productSubTypes[index2]?.quantity || "",
                })
              ),
            },
          })
  ...
  const handleCloseDialog = () => {
    setEditProductTypeDialog(false);
    setProductPickType1({
      nameType: "",
      productTypes: [""],
    });
                ...
                <tr key={index}>
                  ...
                  <td>
                    <input
                      ...
                      placeholder="0"
                      // placeholder={
                      //   errorValidate?.productCombineTypes1?.[index]?.price?.error
                      //     ? "ระบุ"
                      //     : "0"
                      // }
                      type="number"
                  ...
                  <td>
                    <input
                      ...
                      placeholder="0"
                      // placeholder={
                      //   errorValidate?.productCombineTypes1?.[index]?.quantity
                      //     ?.error
                      //     ? "ระบุ"
                      //     : "0"
                      // }
                        ...
                        (productSubType, index2) => (
                          <div key={index2}>
                            <input
                              ...
                              placeholder="0"
                              // placeholder={
                              //   errorValidate?.productCombineTypes1?.[index1*index2]?.price
                              //     ?.error
                              //     ? "ระบุ"
                              //     : "0"
                              // }
                        ...
                        (productSubType, index2) => (
                          <div key={index2}>
                            <input
                              ...
                              placeholder="0"
                              // placeholder={
                              //   errorValidate?.productCombineTypes1?.[index1]?.quantity
                              //     ?.error
                              //     ? "ระบุ"
                              //     : "0"
                              // }
                        ...
                        {productType?.picture?.preview ? (
                          <>
                            ...
                            {errorValidate?.checkPicture?.[index]?.picture
                              .error ? (
                              <div style={{ marginLeft: "35px", color: "red" }}>
                                {
                                  errorValidate?.checkPicture?.[index]?.picture
                                    .message
                                }
                          ...
                          <>
                            <div>
                              ...
                              {errorValidate?.checkPicture?.[index]?.picture
                                ...
                                >
                                  {
                                    errorValidate?.checkPicture?.[index]
                                      ?.picture.message
                                  }
                                </div>
                              ) : null}
...
export default EditProductPickType;
